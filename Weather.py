appid = "5bee683e9445c32e34a22d2b605b4adc"# полученный при регистрации на OpenWeatherMap.org. Что-то вроде такого набора букв и цифр: "6d8e495ca73d5bbc1d6bf8ebd52c4123"

import requests

print("id 520555 name: Nizhniy Novgorod")
city_id = input("Введите id городa из списка", )
